...
|---|:---:|:---:|
| __ResNet based on paper__  | [Code Link]( https://github.com/Deepstroy/Inventory/blob/master/ResNet_result.png)  | ![](https://github.com/Deepstroy/ResNet_based_on_paper/blob/master/Resnet_version1.ipynb) |
